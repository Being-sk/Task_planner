 ...
 * To use the application, you must provide your Firebase configuration here.
...
if (isPlaceholder) {
  console.warn("Firebase is using placeholder values. Please set up your .env file or update src/firebase/config.js");
}
